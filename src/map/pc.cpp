...
void pc_bonus(map_session_data *sd,int32 type,int32 val)
{
	...
	switch(type){
		...
		default:
			...
			if( bonus_seam()->onBonus( sd, type, val ) )
				break;
#endif
...
void pc_bonus2(map_session_data *sd,int32 type,int32 type2,int32 val)
{
	...
	default:
			...
			// switch(type) — the single fall-through for unrecognized ids; if upstream
			// splits the switch, re-attach to whichever keeps the unknown-type default.
			if( bonus_seam()->onBonus2( sd, type, type2, val ) )
				break;
#endif
		if (current_equip_combo_pos > 0) {
...
void pc_bonus3(map_session_data *sd,int32 type,int32 type2,int32 type3,int32 val)
{
	...
	default:
			...
			// switch(type) — the single fall-through for unrecognized ids; if upstream
			// splits the switch, re-attach to whichever keeps the unknown-type default.
			if( bonus_seam()->onBonus3( sd, type, type2, type3, val ) )
				break;
#endif
		if (current_equip_combo_pos > 0) {
...
void pc_bonus4(map_session_data *sd,int32 type,int32 type2,int32 type3,int32 type4,int32 val)
{
	...
	default:
			...
			// switch(type) — the single fall-through for unrecognized ids; if upstream
			// splits the switch, re-attach to whichever keeps the unknown-type default.
			if( bonus_seam()->onBonus4( sd, type, type2, type3, type4, val ) )
				break;
#endif
		if (current_equip_combo_pos > 0) {
...
void pc_bonus5(map_session_data *sd,int32 type,int32 type2,int32 type3,int32 type4,int32 type5,int32 val)
{
	...
	default:
			...
			// switch(type) — the single fall-through for unrecognized ids; if upstream
			// splits the switch, re-attach to whichever keeps the unknown-type default.
			if( bonus_seam()->onBonus5( sd, type, type2, type3, type4, type5, val ) )
				break;
#endif
		if (current_equip_combo_pos > 0) {
